...
# Payout table (halved values from the original)
PAYOUTS = {
    "🍒": 1,  # Was 2
    "🔔": 2,  # Was 4
    "🍋": 1,  # Was 3
...
class SlotMachineGUI:
    def __init__(self, root):
        ...
        self.reel_labels = [[tk.Label(root, text="🎰", font=("Arial", 18), fg="yellow", bg="black", width=3, height=2, borderwidth=1, relief="groove")
