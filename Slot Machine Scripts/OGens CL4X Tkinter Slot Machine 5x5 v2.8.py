...
def spin_reels():
    """Spin the reels and return a 5x5 grid of random symbols using true randomness."""
...
def check_paylines(reels, bet):
    ...
    extra_credits = 0
    paylines = [
        [(0, 0), (0, 1), (0, 2), (0, 3), (0, 4)],  # Horizontal row 1
        [(1, 0), (1, 1), (1, 2), (1, 3), (1, 4)],  # Horizontal row 2
        [(2, 0), (2, 1), (2, 2), (2, 3), (2, 4)],  # Horizontal row 3
        [(3, 0), (3, 1), (3, 2), (3, 3), (3, 4)],  # Horizontal row 4
        [(4, 0), (4, 1), (4, 2), (4, 3), (4, 4)],  # Horizontal row 5
        [(0, 0), (1, 0), (2, 0), (3, 0), (4, 0)],  # Vertical column 1
        [(0, 1), (1, 1), (2, 1), (3, 1), (4, 1)],  # Vertical column 2
        [(0, 2), (1, 2), (2, 2), (3, 2), (4, 2)],  # Vertical column 3
        [(0, 3), (1, 3), (2, 3), (3, 3), (4, 3)],  # Vertical column 4
        [(0, 4), (1, 4), (2, 4), (3, 4), (4, 4)],  # Vertical column 5
        [(0, 0), (1, 1), (2, 2), (3, 3), (4, 4)],  # Diagonal top-left to bottom-right
        [(0, 4), (1, 3), (2, 2), (3, 1), (4, 0)],  # Diagonal top-right to bottom-left
        [(0, 0), (1, 1), (2, 2), (3, 1), (4, 0)],  # V-shape 1
        [(0, 4), (1, 3), (2, 2), (3, 3), (4, 4)],  # V-shape 2
        [(0, 0), (1, 2), (2, 4), (3, 2), (4, 0)],  # Zigzag
        [(0, 0), (1, 1), (2, 2), (3, 1), (4, 2)],  # Inverted V-shape 1
        [(0, 4), (1, 3), (2, 2), (3, 3), (4, 2)],  # Inverted V-shape 2
        [(0, 0), (1, 1), (2, 0), (3, 1), (4, 0)],  # W-shape 1
        [(0, 4), (1, 3), (2, 4), (3, 3), (4, 4)],  # W-shape 2
        [(0, 2), (1, 3), (2, 4), (3, 3), (4, 2)],  # Zigzag inverted
        [(0, 0), (0, 1), (0, 2)],  # 3-symbol horizontal (row 1, left)
        [(0, 2), (0, 3), (0, 4)],  # 3-symbol horizontal (row 1, right)
        [(2, 0), (2, 1), (2, 2)],  # 3-symbol horizontal (row 3, left)
        [(0, 0), (1, 0), (2, 0)],  # 3-symbol vertical (column 1, top)
        [(2, 2), (3, 2), (4, 2)]   # 3-symbol vertical (column 3, bottom)
    ]
    for i, line in enumerate(paylines):
        ...
        if all(s == ref_symbol or s == "💎" for s in symbols):
            ...
            if len(line) < 5 and ref_symbol in ["🍒", "🍋", "🍉", "🍊"]:
                multiplier = 1
            else:
                multiplier = multiplier // 2 if len(line) < 5 else multiplier  # Integer division for other partial paylines
...
def check_bonus(reels, bonus_chance=False):
    """Check if any row triggers the bonus (five 💎), with optional increased chance."""
    if bonus_chance:
...
class SlotMachineGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("Advanced Python Slot Machine (5x5)")
        ...
        # Reel labels (5x5 grid)
        self.reel_labels = [[tk.Label(root, text="🎰", font=("Arial", 18), fg="red", bg="black", width=3, height=2, borderwidth=1, relief="groove")
