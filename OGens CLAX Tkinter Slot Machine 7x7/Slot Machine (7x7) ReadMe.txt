...
- **Paylines**: 40 predefined paylines (horizontal, vertical, diagonal, and patterns like V-shape, zigzag, W-shape, and inverted V-shape) checked for wins.
- **Currency**: 
...
- **Free Spins**: Triggered by seven 💎 symbols in the middle row or by purchasing from the store, granting 5 free spins (`FREE_SPINS = 5`). Free spins use the current bet for payouts but do not deduct from the balance.
...
### Extra Credits
For each winning payline, you also receive **random extra credits** (between 1 and 50, generated using `secrets.randbelow(50) + 1`). If Lucky Charm is active, extra credits are doubled (2–100 per winning payline) for the next spin.  
These credits are added to your total credits, which can be used to purchase items in the store (e.g., extra spins, balance boosts, Mystery Prize, or Lucky Charm).

**Example**: If you hit two paylines in a single spin (e.g., one 🍒 and one ⭐) with Lucky Charm active, you might earn `floor(10 × 1) = 10 coins` (🍒) + `floor(10 × 3) = 30 coins` (⭐) = 40 coins, plus, for example, 50 × 2 = 100 credits for the 🍒 payline and 30 × 2 = 60 credits for the ⭐ payline, totaling 160 credits.

### Free Spins Mode
- **Trigger**: Activated by seven 💎 symbols in the middle row (row 4, index 3, checked via `check_bonus`) or by purchasing "Free Spins Purchase" from the store.
...
- **Winnings**: Payouts from paylines and extra credits (1–50 per winning payline, or 2–100 if Lucky Charm was active before triggering) accumulate over the 5 spins. Total coins are added to the balance, and credits are added to the credit balance at the end.
...
- **Lucky Charm** (100 credits): Doubles extra credits (2–100 per winning payline) on the next spin, enhancing credit earnings without affecting coin payouts.
...
- **Visual Feedback**:
  ...
  - Status messages indicate wins (green), losses (red), free spins (blue), or jackpots (purple). Lucky Charm activation is shown in blue.
...
- **Spin**:
  ...
  - Free spins trigger on seven 💎 symbols (middle row) or store purchase, running 5 spins.
...
- **Lucky Charm Purchase**:
  - Spend 100 credits (credits: 0 or 65, depending on Mystery Prize).
  - Activates Lucky Charm for the next spin, doubling extra credits for winning paylines.
- **Extra Spin** (if awarded by Mystery Prize):
  - Uses 1 extra spin (extra spins: 0), no coins deducted.
  - Hits ⭐ payline (`floor(10 × 3) = 30 coins`, 40 × 2 = 80 credits with Lucky Charm). Balance: 240, credits: 80 or 145.
- **Free Spins** (triggered by seven 💎 in middle row):
  - 5 spins, each checking paylines with 10-coin bet.
  - Spin 1: Hits 🍒 payline (`floor(10 × 1) = 10 coins`, 50 credits or 100 credits with Lucky Charm). Total so far: 10 coins, 50 or 100 credits.
...
This README provides a complete overview of the 7x7 slot machine game, covering payouts, extra credits, the Mystery Prize, Lucky Charm, and all mechanics for regular and free spins, ensuring players understand how to play and what to expect from wins.